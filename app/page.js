  ...
  return <div className="marketing-page">
    ...
    <main id="main-content">
      ...
      <section id="pricing" className="mk-pricing mk-section" aria-labelledby="pricing-title"><div className="mk-wrap">
        <div className="mk-section-heading"><div><p className="mk-kicker">An early seat at the desk</p><h2 id="pricing-title">{ALPHA_OFFER.trialLabel}.<br /><span>Keep your alpha rate.</span></h2></div><p>Try the Windows alpha before your monthly subscription begins. Your Anthropic API usage and DocuSign account are separate.</p></div>
        <div className="mk-pricing-grid"><article className="mk-alpha-plan"><div className="mk-plan-heading"><div><span className="mk-kicker">Windows desktop</span><h3>{ALPHA_OFFER.name}</h3></div><span className="mk-plan-badge">Early access</span></div><div className="mk-plan-price"><strong>{ALPHA_OFFER.priceLabel}</strong><span>{ALPHA_OFFER.intervalLabel}<small>USD · after your trial</small></span></div><p className="mk-plan-rate">{ALPHA_OFFER.rateNotice}</p><ul className="mk-plan-features"><li>Connected messages in one workspace</li><li>Deal Desk and Rolodex</li><li>Claude features with your Anthropic API key</li><li>DocuSign in the app with your own account</li></ul><Link className="mk-button" href={ALPHA_OFFER.signupHref}>{ALPHA_OFFER.checkoutLabel} <span aria-hidden="true">↗</span></Link><p className="mk-plan-billing">{ALPHA_OFFER.billingNotice}</p><p className="mk-plan-extras">Anthropic API usage and DocuSign charges are not included.</p></article>
      ...
      <section className="mk-final"><div className="mk-wrap"><MarketingMark size={42} /><p className="mk-kicker">Messages into momentum</p><h2>Your next deal<br />is already a <span>conversation.</span></h2><p>Give it a home in Merger.</p><Link className="mk-button" href={ALPHA_OFFER.signupHref}>{ALPHA_OFFER.checkoutLabel} <span aria-hidden="true">↗</span></Link><span className="mk-final-price">{ALPHA_OFFER.trialLabel}, then {ALPHA_OFFER.priceLabel} {ALPHA_OFFER.intervalLabel} · Card required</span></div></section>
    </main>
