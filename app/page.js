...
export default function LandingPage() {
  return <div className="marketing-page">
    ...
    <main id="main-content">
      ...
      <section className="mk-final"><div className="mk-wrap"><MarketingMark size={42} /><p className="mk-kicker">Messages into momentum</p><h2>Your next deal<br />is already a <span>conversation.</span></h2><p>Give it a home in Merger.</p><Link className="mk-button" href={ALPHA_OFFER.signupHref}>{ALPHA_OFFER.checkoutLabel}</Link><span className="mk-final-price">{ALPHA_OFFER.trialLabel}, then {ALPHA_OFFER.priceLabel} {ALPHA_OFFER.intervalLabel} · Card required</span></div></section>
    </main>
